<x-admin-layout>
    ...
    <div class="bg-white p-8 mb-5 rounded w-1/2 text-darker-black">
        ...
        <form action="{{ route('admin.weapon.update', $weapon->id) }}" method="POST" class="flex flex-col gap-4"
            ...
            <div>
                ...
                <input type="text" id="kode" class="border border-line-stroke text-sm rounded block w-full p-2"
                    placeholder="Weapon kode" name="kode" value="{{ $weapon->kode }}">
            ...
            <div>
                ...
                <input type="text" id="name" class="border border-line-stroke text-sm rounded block w-full p-2"
                    placeholder="Weapon name" name="name" value="{{ $weapon->name }}">
            ...
            <div>
                ...
                <input type="number" id="price" class="border border-line-stroke text-sm rounded block w-full p-2"
                    placeholder="Weapon price" name="price" value="{{ $weapon->price }}">
                        ...
                        <li class="w-full border-b border-gray-200 rounded-t-lg dark:border-gray-600">
                            <div class="flex items-center ps-3">
                                <input id="vue-checkbox" type="checkbox"
                                    {{ in_array($category->id, $weapon->categories->pluck('id')->toArray()) ? 'checked' : '' }}
                                    value="{{ $category->id }}"
            ...
            <div>
                ...
                <textarea id="message" rows="4"
                    ...
                    placeholder="Write your thoughts here..." name="description">{{ $weapon->description }}</textarea>
      ...
      py-3 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Edit
                Weapon</button>
        </form>
    </div>
</x-admin-layout>
